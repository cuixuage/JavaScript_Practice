...
//****************************************************这是IIFE立即调用函数
//****************************************************这是immediately-invoked function expression立即调用函数
  ...
  function offerExpires(today) {
    ...
    weekFromToday = new Date(today.getTime() + 7 * 24 * 60 * 60 * 1000);           //当前时间+7天的毫秒数
  ...
  elEnds.innerHTML = offerExpires(today);         // Add the expiry message       //前面声明了 offerExpires函数
